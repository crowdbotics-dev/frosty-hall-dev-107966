"""
Django settings for frosty_hall_dev_107966 project.
...
ROOT_URLCONF = 'frosty_hall_dev_107966.urls'
...
WSGI_APPLICATION = 'frosty_hall_dev_107966.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "frosty_hall_dev_107966 API",
    "DESCRIPTION": "API documentation for frosty_hall_dev_107966 App",
    "VERSION": "v1",
}
